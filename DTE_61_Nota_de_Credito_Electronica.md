# DTE 61 - Nota de Credito Electronica
...
- Este archivo corresponde específicamente al **TipoDTE 61 (Nota de Credito Electronica)**.
- La estructura base proviene de la rama **Documento** del `choice` principal del `DTE_v10.xsd`.
- El campo `TipoDTE` fue acotado en esta documentación al valor **61**.
...
| DTE/Documento/Encabezado/IdDoc/TipoDTE | SiiDte:DTEType | Sí | 1..1 | xs:positiveInteger | - | - | - | 61 | Tipo de DTE (Nota de Credito Electronica) | Tipo específico documentado: 61 = Nota de Credito Electronica |
