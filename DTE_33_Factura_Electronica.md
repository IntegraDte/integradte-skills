...
- Este archivo corresponde específicamente al **TipoDTE 33 (Factura Electronica)**.
- La estructura base proviene de la rama **Documento** del `choice` principal del `DTE_v10.xsd`.
- El campo `TipoDTE` fue acotado en esta documentación al valor **33**.
...
| DTE/Documento/Encabezado/IdDoc/TipoDTE | SiiDte:DTEType | Sí | 1..1 | xs:positiveInteger | - | - | - | 33 | Tipo de DTE (Factura Electronica) | Tipo específico documentado: 33 = Factura Electronica |
