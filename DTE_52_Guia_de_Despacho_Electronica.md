# DTE 52 - Guia de Despacho Electronica
...
- Este archivo corresponde específicamente al **TipoDTE 52 (Guia de Despacho Electronica)**.
- La estructura base proviene de la rama **Documento** del `choice` principal del `DTE_v10.xsd`.
- El campo `TipoDTE` fue acotado en esta documentación al valor **52**.
...
| DTE/Documento/Encabezado/IdDoc/TipoDTE | SiiDte:DTEType | Sí | 1..1 | xs:positiveInteger | - | - | - | 52 | Tipo de DTE (Guia de Despacho Electronica) | Tipo específico documentado: 52 = Guia de Despacho Electronica |
