...
| `Documento/TED/DD/TD` | Debe ser `41` |
| `Documento/TED/DD/CAF/DA/TD` | Debe ser `41` |
...
| `Documento/TED/DD/TD` | `DTEType` | Sí | `1..1` | — | — | — | — | Tipo DTE | valor esperado en este documento: 41 |
...
| `Documento/TED/DD/CAF/DA/TD` | `DTEType` | Sí | `1..1` | — | — | — | — | Tipo DTE | valor esperado en este documento: 41 |
